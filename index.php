...
<html>
<head>
<title>Sistem Bonus Pegawai | Home :: Bagas</title>
  		...
  		<!--banner-->	
		   ...
		   <div class="blank">
			   <div class="blank-page">
					<?php
					if(isset($_GET['page']) AND file_exists('page/'.$_GET['page'].'.php')){include "page/".$_GET['page'].'.php';} else {include "page/home.php";}
					?>
			   </div>
		   </div>
<div class="copy">
            <p> &copy; 2016 Minimal. All Rights Reserved | Design by <a href="#" target="_blank">W3layouts</a> </p>
	    </div>
		</div>
		<div class="clearfix"> </div>
       </div>
